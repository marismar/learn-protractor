...
class Form {
  constructor () {
    ...
    this.nameInputWithError = this.self.element(by.css('.field_with_errors #destination_name')) // prettier-ignore
    this.descriptionLabel = this.self.element(by.css('label[for="destination_description"]')) // prettier-ignore
    this.descriptionInput = this.self.element(by.id('destination_description'))
    this.descriptionInputWithError = this.self.element(by.css('.field_with_errors #destination_description')) // prettier-ignore
